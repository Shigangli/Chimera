...
#SBATCH --account=g34
#SBATCH --output=bert48_32nodes_pipedream_8b_1steps_4wx8d.txt
...
cd ../baselines/bert_pipedream2bw/bert/
srun python main_with_runtime.py \
        ...
        --do_lower_case \
        --num_minibatches 128 \
        --gradient_accumulation_steps 1 --pipedream --config_path tests/depth=8/conf_32nodes.json
