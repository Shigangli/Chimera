...
#SBATCH --account=g34
#SBATCH --output=1-gpt2_32nodes_chimera_1b_1s_32layers_4pipes.txt
...
cd ..
srun python main_with_runtime_4pipes.py \
        ...
        --reverse_config_path_1 tests/depth=32/conf_reverse_pipe_32nodes_1.json --chimera
