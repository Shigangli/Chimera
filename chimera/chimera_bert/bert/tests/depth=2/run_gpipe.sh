python -m launch --nnodes=1 --nproc_per_node=2 main_with_runtime.py \
        --master_addr=localhost \
        --module models.bert48.depth=2 \
        --max_seq_length 128 \
        --train_batch_size 8 \
        ...
        --do_lower_case \
        --num_minibatches 256 \
        --gradient_accumulation_steps 1 --recompute_step --config_path tests/depth=2/conf.json --gpipe
