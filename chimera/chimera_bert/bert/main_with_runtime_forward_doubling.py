    ...
    if args.do_train:
        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            if args.gpipe:
                ...
                acc_steps = update_interval // half_stages
                ...
                schedule_number_c = schedule_number_b + half_stages
                ...
                if acc_steps == 1:
                    ...
                    # the tail of the pipelines, only backward passes
                    ...
                    assert acc_steps%2 == 0

                    doubling_steps = acc_steps // 2
                    ...
                    for doubling_step in range(doubling_steps):
                        ...
                        for step_p4 in range(schedule_number_c):
                            if first_half == True:
                                r.run_backward(recompute_step=recompute_step)
                                r_reverse.run_backward(recompute_step=recompute_step_reverse)
                            else:
                        ...
                        # early invoke grad_sync
                        if doubling_step == doubling_steps - 1:
                            if r.stage > half_stages:
                                optimizer.grads_sync()
                            if r_reverse.stage > half_stages: 
                                optimizer_reverse.grads_sync()
