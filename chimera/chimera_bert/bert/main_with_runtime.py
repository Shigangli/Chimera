...
def main():
    ...
    if not args.gpipe and not args.no_input_pipelining and not args.chimera:
    ...
    if args.do_train:
        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            if args.gpipe:
                ...
                print("rank = ", args.rank, ", stage = ", r.stage, "reverse_stage = ", r_reverse.stage, ", schedule numbers: ", schedule_number_a, schedule_number_b, "first_half: ", first_half, "update iv: ", update_interval, "r update iv: ", r.update_interval, " flush_group_ranks: ", flush_group_ranks)
                ...
                if epoch != 0:
                    ...
                    #optimizer_reverse.zero_grad()        
                    #r_reverse._print_training_progress(base_step+r_reverse.update_interval-1, n, start_time, 
                    #                                      epoch_start_time, loss_reverse, cumulative_loss_reverse)
        
                    #with contextlib.ExitStack() as stack:
                    #    for context_handler in r.context_handlers() + r_reverse.context_handlers():
                    ...
                    #if args.local_rank != -1:
                    #    distrib.barrier()
                #print("finish rank = ", args.rank, ", Finish 1 epoch by dpp.")
