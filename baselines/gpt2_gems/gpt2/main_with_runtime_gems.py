...
def train(args, configuration_maps, train_dataset,
    ...
    if not args.gpipe and not args.dapple and not args.chimera and not args.gems and not args.no_input_pipelining:
    ...
    for epoch in range(int(args.num_train_epochs)):
        ...
        if args.gpipe:
            ...
            print("rank = ", args.rank, ", stage = ", r.stage, "reverse_stage = ", r_reverse.stage, "update iv: ", update_interval, "r update iv: ", r.update_interval)
        ...
        print("Epoch %d (%d iterations): %.3f seconds" % (
            epoch, n, time.time() - epoch_start_time1))
